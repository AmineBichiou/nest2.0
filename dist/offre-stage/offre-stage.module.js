...
exports.OffreStageModule = OffreStageModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'OffreStage', schema: offre_stage_model_1.OffreStageSchema }]), (0, common_1.forwardRef)(() => auth_module_1.AuthModule)],
